...
- The weightage is pretty arbitrary and is based on how I personally view emails. I am open to suggestions as to how these can be less random and more mathematical. This is the meat of this application and is what makes it intelligent, so it would definitely help to have a more rigid weighting system than the one in place right now. The system in place is also a little decentralized, perhaps a seperate module for purely weighting usernames/emails would be beneficial.
- The more common the name is, the higher chance there is of having a username like "john_doe_1994". I weight these usernames low compared to "john_doe" and "jdoe" for example and I'm not sure if this is the best way to go about this. If there is any way to measure how "common" a name is, that would be great.